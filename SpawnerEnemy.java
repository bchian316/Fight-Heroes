...
public abstract class SpawnerEnemy extends Enemy {
    ...
    public SpawnerEnemy(String name, int x, int y, int size, int health, int speed, int reload, int passiveRange, AttackStats attk, int power, int spawnTime) {
        super(name, x, y, size, health, speed, reload, passiveRange, attk, power);
