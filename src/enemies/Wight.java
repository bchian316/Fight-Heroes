...
public class Wight extends Enemy {
    ...
    public ArrayList<Projectile> attack(double targetX, double targetY) {
        ...
        newProjs.add(new Projectile(this.getCenterX(), this.getCenterY(), angle, new AttackStats(8, 35, 13, 300, -1, 3, new Color(80, 80, 80))));
        newProjs.add(new Projectile(this.getCenterX()
                - Wight.ATTKOFFSET, this.getCenterY() - Wight.ATTKOFFSET, angle, new AttackStats(8, 35, 13, 300, -1, 3, new Color(80, 80, 80))));
        newProjs.add(new Projectile(this.getCenterX()
                - Wight.ATTKOFFSET, this.getCenterY() + Wight.ATTKOFFSET, angle, new AttackStats(8, 35, 13, 300, -1, 3, new Color(80, 80, 80))));
        newProjs.add(new Projectile(this.getCenterX()
                + Wight.ATTKOFFSET, this.getCenterY() - Wight.ATTKOFFSET, angle, new AttackStats(8, 35, 13, 300, -1, 3, new Color(80, 80, 80))));
