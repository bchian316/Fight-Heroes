...
public class PlasmaMage extends Mage {
    ...
    public ArrayList<Projectile> createProjectiles(double x, double y, double targetX, double targetY) {
        ...
        newProjs.add(new Projectile(x, y, angle,
                new AttackStats(13, 25, 10, 200, 1, 25, new Color(255, 115, 115), true,
    ...
    public ArrayList<Projectile> special(Player p, double targetX, double targetY) {
        ...
        newProjs.add(new Projectile(p.getCenterX(), p.getCenterY(), angle,
                new AttackStats(0, 40, 9, 350, 1, 25, new Color(0, 104, 240), true,
                        new AttackStats(
    ...
    public ArrayList<Projectile> special2(double x, double y, double angle, AttackStats splitStats) {
        ...
        for (int i = 0; i < 12; i++) {
            //split is independent of past angle (like spike)
            newProjs.add(new Projectile(x, y, Math.toRadians(i*30), splitStats));
        }
        return newProjs;
    }
