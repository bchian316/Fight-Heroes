...
public class NatureMage extends Mage {
    public NatureMage() {
        super("Nature Mage", 80, 125, 10, 6, 1000, new AttackStats(30, 40, 15, 100, new Color(0, 200, 0), true,
                new AttackStats(20, 20, 15, 100, new Color(0, 255, 0), true, new AttackStats(10, 10, 15, 100, new Color(0, 255, 0)))));
    }
